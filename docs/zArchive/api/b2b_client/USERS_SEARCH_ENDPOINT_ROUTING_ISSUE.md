...
**Status**: Problem description and requirements for backend; no prescribed implementation.
...
- Contract: `docs/backend/feedback_for_backend/SEARCH_API_FOR_DISCRETIONARY_RECIPIENTS.md`.
