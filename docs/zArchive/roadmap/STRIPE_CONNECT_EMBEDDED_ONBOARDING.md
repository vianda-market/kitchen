...
### Documentation
- [ ] Update `docs/api/b2b_client/API_CLIENT_SUPPLIER_PAYOUT.md` with embedded flow and aggregator model
...
- B2B integration guide: `docs/api/b2b_client/API_CLIENT_SUPPLIER_PAYOUT.md`
