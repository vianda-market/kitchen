...
**File**: `docs/postman/collections/TIMEZONE_DEDUCTION_TESTS.postman_collection.json`
...
```bash
# Import collection: docs/postman/collections/TIMEZONE_DEDUCTION_TESTS.postman_collection.json
...
6. ✅ `docs/postman/collections/TIMEZONE_DEDUCTION_TESTS.postman_collection.json` - Created test suite
...
2. **QA Team**: Run Postman collection `docs/postman/collections/TIMEZONE_DEDUCTION_TESTS.postman_collection.json` to validate
