...
ALTER TABLE vianda_info ADD COLUMN IF NOT EXISTS created_by UUID NULL;
ALTER TABLE vianda_history ADD COLUMN IF NOT EXISTS created_by UUID NULL;
...
ALTER TABLE vianda_kitchen_days ADD COLUMN IF NOT EXISTS created_by UUID NULL;
ALTER TABLE vianda_kitchen_days_history ADD COLUMN IF NOT EXISTS created_by UUID NULL;
ALTER TABLE vianda_selection_info ADD COLUMN IF NOT EXISTS created_by UUID NULL;
ALTER TABLE vianda_selection_history ADD COLUMN IF NOT EXISTS created_by UUID NULL;
ALTER TABLE vianda_pickup_live ADD COLUMN IF NOT EXISTS created_by UUID NULL;
