...
2. **Import the updated collection**:
   - Click "Import" button
   - Select `docs/postman/collections/DISCRETIONARY_CREDIT_SYSTEM.postman_collection.json`
...
```bash
grep -n "admin/discretionary/requests" docs/postman/collections/DISCRETIONARY_CREDIT_SYSTEM.postman_collection.json | head -5
```
