...
Import `docs/postman/Geolocation Testing.postman_collection.json` into Postman.
...
- **Gateway Architecture**: `docs/infrastructure/EXTERNAL_SERVICE_GATEWAY.md`
- **Phase 0 Summary**: `docs/infrastructure/PHASE_0_COMPLETION_SUMMARY.md`
- **Phase 0.5 Summary**: `docs/infrastructure/PHASE_0.5_TESTING_COMPLETION.md`
- **Testing Guidelines**: `docs/CLAUDE.md` (Testing Standards section)
- **E2E Collection**: `docs/postman/E2E Plate Selection.postman_collection.json`
