...
fintech_link_transaction   → Payment processing
...
**Tables**: `client_bill_info`, `client_transaction`, `fintech_link_transaction`
...
"fintech_transactions": ("app.models.payment_methods.fintech_link_transaction", "FintechLinkTransaction"),
```
