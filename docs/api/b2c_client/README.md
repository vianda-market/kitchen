...
- **Vianda recommendation and favorites**: [VIANDA_RECOMMENDATION_AND_FAVORITES_B2C.md](./VIANDA_RECOMMENDATION_AND_FAVORITES_B2C.md) — Recommended badges, favorite hearts, favorites API; explore integration for Customers.
...
- **Pickup availability and charging**: [PICKUP_AVAILABILITY_AT_KITCHEN_START.md](./PICKUP_AVAILABILITY_AT_KITCHEN_START.md) — When viandas become ready (11:30), deferred charging, no refund after lock.
