...
- **Enriched Endpoints**: See [shared_client/ENRICHED_ENDPOINT_PATTERN.md](./shared_client/ENRICHED_ENDPOINT_PATTERN.md) for using enriched endpoints
- **Archived Records**: See [shared_client/ARCHIVED_RECORDS_PATTERN.md](./shared_client/ARCHIVED_RECORDS_PATTERN.md) for handling archived records
