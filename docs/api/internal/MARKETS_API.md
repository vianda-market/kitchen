...
Request `country_code`: ISO 3166-1 alpha-2; normalized to uppercase at the API boundary (case-insensitive input accepted).
...
CREATE TABLE market_info (
    ...
    country_code VARCHAR(2) NOT NULL UNIQUE,  -- ISO 3166-1 alpha-2 (AR, PE, CL, US)
