...
**Endpoint**: `POST /plate-kitchen-days/`
...
|----------|---------|--------|----------------|
| `POST /plate-kitchen-days/` | Pattern 1 (Array in body) | ✅ Implemented | Suppliers (institution-scoped), Employees (global) |
| `POST /national-holidays/bulk` | Pattern 2 (Separate endpoint) | ✅ Implemented | Employees only |
