...
PUT /api/v1/users/me  // ✅ NEW: Use /me endpoint for self-updates
{
  "first_name": "John",
  "last_name": "Doe"
}

// ⚠️ DEPRECATED: Don't use /users/{user_id} for self-updates
PUT /api/v1/users/{customer_user_id}  // ❌ Will log deprecation warning
...
**Example**:
```typescript
// Customer accessing their own user - ✅ Use /me endpoint (NEW)
GET /api/v1/users/me

// ⚠️ DEPRECATED: Don't use /users/{user_id} for self-reads
GET /api/v1/users/{customer_user_id}  // Will log deprecation warning
