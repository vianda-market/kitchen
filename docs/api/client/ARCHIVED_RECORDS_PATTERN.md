...
```
GET /api/v1/users/
GET /api/v1/users/?include_archived=false
```

**Include archived records:**
```
GET /api/v1/users/?include_archived=true
```
...
**Base Endpoints:**
```
GET /api/v1/users/                          # Excludes archived (default)
GET /api/v1/users/?include_archived=false   # Explicitly excludes archived
GET /api/v1/users/?include_archived=true    # Includes archived
GET /api/v1/users/{user_id}                 # Excludes archived (default)
GET /api/v1/users/{user_id}?include_archived=true  # Includes archived
```

**Enriched Endpoints:**
```
GET /api/v1/users/enriched/                          # Excludes archived (default)
GET /api/v1/users/enriched/?include_archived=false   # Explicitly excludes archived
GET /api/v1/users/enriched/?include_archived=true    # Includes archived
GET /api/v1/users/enriched/{user_id}                 # Excludes archived (default)
GET /api/v1/users/enriched/{user_id}?include_archived=true  # Includes archived
```
