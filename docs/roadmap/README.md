...
| [CONFIG_TO_DB_MIGRATION.md](CONFIG_TO_DB_MIGRATION.md) | Phase 9: move operational config (kitchen hours, location/timezone, enum labels, messages, archival) from Python to DB + admin; ops without deploy |
...
| [DEV_STAGING_PROD_ENVIRONMENTS.md](../zArchive/roadmap/DEV_STAGING_PROD_ENVIRONMENTS.md) | *(Archived)* Dev/Staging/Prod configuration; Pulumi now handles deployment. |
