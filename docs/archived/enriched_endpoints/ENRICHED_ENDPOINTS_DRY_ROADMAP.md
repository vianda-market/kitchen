...
9. `get_enriched_fintech_links()` / `get_enriched_fintech_link_by_id()`
10. `get_enriched_subscriptions()` / `get_enriched_subscription_by_id()`
11. `get_enriched_institution_bills()`
12. `get_enriched_institution_bank_accounts()`
13. `get_enriched_plate_pickups()`
