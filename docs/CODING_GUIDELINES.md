...
institution_bank_account_service.get_by_id()
institution_bank_account_service.create()
institution_bank_account_service.soft_delete()
```
...
institution_bank_account_service = CRUDService(...)  # Has get_by_id()

def get_bank_account_by_id(...):  # ❌ Redundant!
...
def get_all_bank_accounts(
    institution_entity_id: Optional[UUID] = Query(None),
