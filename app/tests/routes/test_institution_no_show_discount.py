...
Only Supplier institutions carry no_show_discount. Employee, Customer, and Employer
...
@pytest.fixture
def admin_user():
    """Employee Admin user with global access for institution operations."""
    return {
        "user_id": str(uuid4()),
        "role_type": "Employee",
        "role_name": "Admin",
...
def super_admin_user():
    """Employee Super Admin user - can create Employee-type institutions."""
    return {
        "user_id": str(uuid4()),
        "role_type": "Employee",
...
class TestInstitutionCreateNoShowDiscountScoping:
    ...
    def test_create_employee_institution_with_no_show_discount_strips_value(
        ...
        """POST /api/v1/institutions/ with Employee + no_show_discount: 20 does not persist it."""
        created = MagicMock()
        created.institution_id = uuid4()
        created.name = "Test Institution"
        created.institution_type = "Employee"
        ...
        payload = _institution_create_payload("Employee", no_show_discount=20)
    ...
    def test_create_employee_institution_as_admin_returns_403(
        ...
        """POST /api/v1/institutions/ with institution_type=Employee as Admin returns 403."""
        payload = _institution_create_payload("Employee", no_show_discount=None)
        payload["name"] = "Test Employee Inc"
        resp = client_with_admin.post("/api/v1/institutions/", json=payload)
...
class TestInstitutionUpdateNoShowDiscountScoping:
    ...
    def test_update_employee_institution_with_no_show_discount_clears_value(
        ...
        existing.institution_type = "Employee"
        existing.name = "Test Employee Inc"
        ...
        updated.institution_type = "Employee"
        updated.name = "Test Employee Inc"
    ...
    def test_update_supplier_to_employee_clears_no_show_discount(
        ...
        """PUT changing institution_type from Supplier to Employee clears no_show_discount."""
        inst_id = uuid4()
        existing = MagicMock()
        existing.institution_id = inst_id
        ...
        resp = client_with_super_admin.put(
            f"/api/v1/institutions/{inst_id}",
            json={"institution_type": "Employee"},
        )
