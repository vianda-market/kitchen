...
from app.services.error_handling import (
    handle_service_call, handle_database_operation, handle_business_operation,
    handle_get_by_id, handle_get_all, handle_create, handle_update, handle_delete
)
...
class TestErrorHandlingService:
    ...
    def test_handle_service_call_passes_arguments_correctly(self, mock_db):
        ...
        result = handle_service_call(
            mock_service, "Error message", None,
