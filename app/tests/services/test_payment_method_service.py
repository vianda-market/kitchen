...
class TestPaymentMethodService:
    ...
    def test_link_payment_method_success(self, mock_db, sample_payment_method_pending):
    ...
    def test_link_payment_method_idempotent_already_linked(self, mock_db, sample_payment_method_active):
    ...
    def test_link_payment_method_idempotent_not_pending(self, mock_db, sample_payment_method_pending):
    ...
    def test_link_payment_method_type_mismatch(self, mock_db, sample_payment_method_wrong_type):
    ...
    def test_link_payment_method_zero_rows_updated(self, mock_db, sample_payment_method_pending):
    ...
    def test_link_payment_method_different_types(self, mock_db, sample_payment_method_pending):
