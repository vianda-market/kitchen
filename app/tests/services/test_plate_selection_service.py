...
class TestPlateSelectionService:
    ...
    def test_create_plate_selection_with_transactions_handles_invalid_plate_id(self, sample_current_user, mock_db):
        ...
        # Arrange
        invalid_payload = {"plate_id": "invalid-uuid", "restaurant_id": str(uuid4()), "target_kitchen_day": "monday"}
    ...
    def test_create_plate_selection_with_transactions_handles_plate_not_found(self, sample_current_user, mock_db):
        ...
        # Arrange
        payload = {"plate_id": str(uuid4()), "restaurant_id": str(uuid4()), "target_kitchen_day": "monday"}
    ...
    def test_create_plate_selection_with_transactions_handles_restaurant_not_found(self, sample_current_user, mock_db):
        ...
        with (
            patch("app.services.plate_selection_service.plate_service") as mock_plate_service,
    ...
    def test_create_plate_selection_with_transactions_blocks_insufficient_credits(self, sample_current_user, mock_db):
        ...
        with (
            ...
            patch("app.services.plate_selection_service.validate_restaurant"),
    ...
    def test_create_plate_selection_with_transactions_rejects_duplicate_kitchen_day(self, sample_current_user, mock_db):
    ...
    def test_create_plate_selection_replace_existing_wrong_id_returns_409(self, sample_current_user, mock_db):
