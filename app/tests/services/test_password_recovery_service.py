...
class TestPasswordRecoveryService:
    ...
    def test_reset_password_sets_user_status_to_active(self, mock_hash_password):
        ...
        with (
            ...
            patch("app.services.password_recovery_service.user_service") as mock_user_svc,
        ):
        ...
        user_update_calls = [
            c for c in execute_calls if c.args and "user_info" in c.args[0] and "hashed_password" in c.args[0]
        ]
