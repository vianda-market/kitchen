...
from app.services.date_service import get_effective_current_date, get_effective_current_day, is_dev_mode
...
class TestDateService:
    ...
    def test_get_effective_current_day_handles_invalid_timezone(self, mock_settings):
        ...
        with (
            patch("app.services.kitchen_day_service.datetime") as mock_datetime,
    ...
    def test_get_effective_current_date_handles_invalid_timezone(self, mock_settings):
        ...
        with (
            patch("app.services.date_service.datetime") as mock_datetime,
