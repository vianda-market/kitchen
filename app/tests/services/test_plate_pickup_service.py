...
class TestPlatePickupServiceSimple:
    ...
    def test_scan_qr_code_validates_qr_code_not_found(self, sample_current_user, mock_db):
        ...
        with (
            patch("app.services.plate_pickup_service.plate_pickup_live_service") as mock_pickup_service,
    ...
    def test_get_plate_delivery_info_handles_plate_not_found(self, mock_db):
        ...
        with (
            patch("app.services.plate_pickup_service.plate_selection_service") as mock_plate_selection_service,
