...
from app.security.entity_scoping import ENTITY_RESTAURANT_BALANCE, EntityScopingService
...
def get_all_enriched_restaurant_balances(
    ...
    **Note: This is a read-only endpoint. Restaurant balances are automatically
    ...
    result = handle_business_operation(_get_enriched_restaurant_balances, "enriched restaurant balances retrieval")
...
def get_enriched_restaurant_balance(
    ...
    **Note: This is a read-only endpoint. Restaurant balances are automatically
    ...
    return handle_business_operation(_get_enriched_restaurant_balance, "enriched restaurant balance retrieval")
...
def get_all_restaurant_balances(
    ...
    **Note: This is a read-only endpoint. Restaurant balances are automatically
    ...
    def _get_restaurant_balances():
        ...
        balances = restaurant_balance_service.get_all(db, scope=scope, include_archived=False)
        log_info(f"Retrieved {len(balances)} restaurant balances")
        return balances

    return handle_business_operation(_get_restaurant_balances, "restaurant balances retrieval")
...
def get_restaurant_balance(
    ...
    **Note: This is a read-only endpoint. Restaurant balances are automatically
    ...
    return handle_business_operation(_get_restaurant_balance, "restaurant balance retrieval")
