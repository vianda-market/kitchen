...
class MarketConfiguration:
    ...
    @classmethod
    def get_market_config(cls, country_code: str) -> MarketKitchenConfig | None:
    ...
    @classmethod
    def get_market_timezone(cls, country_code: str) -> str | None:
    ...
    @classmethod
    def get_kitchen_close_utc(cls, country_code: str, target_date: datetime, day_name: str) -> datetime | None:
    ...
    @classmethod
    def get_billing_run_utc(cls, country_code: str, target_date: datetime, day_name: str) -> datetime | None:
    ...
    @classmethod
    def get_reservation_opens_utc(cls, country_code: str, target_date: datetime, day_name: str) -> datetime | None:
