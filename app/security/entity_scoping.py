...
class EntityScopingService:
    ...
    @staticmethod
    def get_scope_for_entity(entity_type: str, current_user: dict, **kwargs) -> InstitutionScope | None:
        """
    ...
    @staticmethod
    def _scope_restaurant_balance(current_user: dict, **kwargs) -> InstitutionScope | None:
        """
    ...
    @staticmethod
    def _scope_restaurant_transaction(current_user: dict, **kwargs) -> InstitutionScope | None:
        """
    ...
    @staticmethod
    def _scope_qr_code(current_user: dict, **kwargs) -> InstitutionScope | None:
        """
    ...
    @staticmethod
    def _scope_restaurant(current_user: dict, **kwargs) -> InstitutionScope | None:
        """
    ...
    @staticmethod
    def _scope_product(current_user: dict, **kwargs) -> InstitutionScope | None:
        """
    ...
    @staticmethod
    def _scope_institution_entity(current_user: dict, **kwargs) -> InstitutionScope | None:
        """
    ...
    @staticmethod
    def _scope_institution_bill(current_user: dict, **kwargs) -> InstitutionScope | None:
        """
    ...
    @staticmethod
    def _scope_user(current_user: dict, **kwargs) -> InstitutionScope | None:
        """
    ...
    @staticmethod
    def _scope_address(current_user: dict, **kwargs) -> InstitutionScope | None:
        """
    ...
    @staticmethod
    def _scope_subscription(current_user: dict, **kwargs) -> InstitutionScope | None:
        """
    ...
    @staticmethod
    def _scope_restaurant_holiday(current_user: dict, **kwargs) -> InstitutionScope | None:
        """
    ...
    @staticmethod
    def _scope_default(current_user: dict, **kwargs) -> InstitutionScope | None:
        """
