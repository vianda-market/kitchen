...
import psycopg2
from app.dto.models import InstitutionEntityDTO, AddressDTO, RestaurantDTO
from app.services.crud_service import institution_entity_service, address_service, restaurant_service, get_institution_entities_by_institution
...
class MarketDetectionService:
    ...
    @staticmethod
    def get_country_from_entity(entity_id: UUID, db: psycopg2.extensions.connection) -> Optional[str]:
        """
    ...
    @staticmethod
    def get_country_from_restaurant(restaurant_id: UUID, db: psycopg2.extensions.connection) -> Optional[str]:
        """
    ...
    @staticmethod
    def get_country_from_institution(institution_id: UUID, db: psycopg2.extensions.connection) -> Optional[str]:
        """
    ...
    @staticmethod
    def get_country_from_restaurant_balance(restaurant_id: UUID, db: psycopg2.extensions.connection) -> Optional[str]:
        """
