...
def get_zipcode_metrics(
    ...
    # 4) Optional center: avg lat/lng (Active + plate_kitchen_days)
    center: Optional[dict] = None
    if matched_zipcode and has_coverage:
        query_center = """
        ...
        """
        center_row = db_read(query_center, (country, matched_zipcode), connection=db, fetch_one=True)
