...
class PlatePickupService:
        ...
        try:
            ...
            if completion_type != "user_disputed":
                try:
                    ...
                    selection = plate_selection_service.get_by_id(str(pickup_record.plate_selection_id), db)
    ...
    def _update_restaurant_transaction_arrival(
        ...
        restaurant_transaction = restaurant_transaction_service.get_by_plate_selection(
            pickup_record.plate_selection_id, db
        )
    ...
    def _update_orders_arrival(
        ...
        """
        from app.services.crud_service import plate_service, update_balance_on_arrival
        ...
        for selection in selections:
            try:
                ...
                if transaction_result:
                    ...
                    log_info(
                        f"Transaction for selection {plate_selection_id}: "
