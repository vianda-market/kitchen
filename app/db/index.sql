...
CREATE INDEX idx_user_info_employer_address_id ON user_info(employer_address_id) WHERE employer_address_id IS NOT NULL;
...
CREATE INDEX idx_plate_selection_active ON plate_selection_info(plate_selection_id, kitchen_day);
...
CREATE INDEX idx_institution_settlement_history_settlement_id ON institution_settlement_history(settlement_id);
CREATE INDEX idx_institution_settlement_history_current ON institution_settlement_history(settlement_id, is_current);
